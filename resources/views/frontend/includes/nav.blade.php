            ...
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown">
                        ...
                        <ul class="dropdown-menu" role="menu">
                               <li>{{ link_to_route('frontend.products', trans('Products')) }}</li>
                                <li>{{ link_to_route('frontend.product_types', trans('Product Types')) }}</li>
                                 <li>{{ link_to_route('frontend.attribute.index', trans('Attributes')) }}</li>
                        </ul>
                    </li>
            </ul>
